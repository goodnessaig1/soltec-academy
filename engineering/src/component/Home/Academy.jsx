  ...
  return (
    <div className='w-full flex flex-col pt-[100px] pb-[130px] w-full'>
      <div className='flex flex-col items-center justify-center w-full gap-[31px]'>
        ...
        <span className='text-[18px] px-4 font-medium leading-[26px] text-center text-white'>
                  ...
                  {courseDummyData &&
                    courseDummyData.slice(0, 6).map((course, index) => (
                      <Link
                        ...
                        key={index}
                        className='text-white uppercase pr-4 lg:pr-12  xl:pr-[120px] transition text-[20px] duration-200 leading-[24px] font-semibold hover:text-white hover:cursor-pointer'
                      >
                        {course?.title}
                      </Link>
                    ))}
