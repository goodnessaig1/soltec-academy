import { GoodIcon, Whatsapp } from '../../Utils/assets';

const AboutUs = () => {
  return (
    <div className='w-full md:h-[974px] lg:h-[780px] xl:h-[707px] flex flex-col lg:flex-row'>
      <div className='w-full lg:w-1/2 px-5 lg:pl-10 lg:pr-[60px] xl:px-[100px] xll:px-[120px] py-[52px] lg:py-[64px] xlx:py-[64px] flex flex-col gap-[48px] aboutBg h-full'>
        <div className='flex flex-col gap-[26px]'>
          <h1 className='font-bold text-[18px] lg:text-[24px] leading-[30px] text-white'>
            ABOUT US
          </h1>
        ...
        <div className='flex flex-col gap-[39px]'>
          ...
          <h2 className='font-bold inter__ text-[14px] lg:text-[18px] uppercase leading-[27px] text-higherCol'>
