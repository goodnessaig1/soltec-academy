...
const ContactUs = () => {
  ...
  return (
    <div className='md:min-h-[100vh] lg:min-h-[160vh] w-full bg-[#F7F7F7]'>
      <Header />
      <div className='flex flex-col pt-[60px] md:pt-20 px-4 pb-[100px] items-center justify-center '>
        ...
        <div className='contact_uss px-[24px] py-8 md:p-8 mt-[60px] md:mt-[90px] w-full md:w-[600px] lg:w-[786px] rounded-[6px] flex flex-col lg:flex-row gap-[64px]'>
