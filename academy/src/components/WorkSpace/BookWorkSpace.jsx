          ...
          <div className='w-full flex flex-col lg:flex-row gap-10 mt-[4px] lg:mt-[48px] justify-center items-center'>
            ...
            >
              <div className='flex flex-col gap-5'>
                <h1 className='font-bold text-[24px] leading-[36px]'>DAILY</h1>
                <h1 className='font-bold text-[24px] leading-[36px]'>N3,000</h1>
              </div>
              <Link
            ...
            >
              <div className='flex flex-col gap-5'>
                <h1 className='font-bold text-[24px] leading-[36px]'>WEEKLY</h1>
