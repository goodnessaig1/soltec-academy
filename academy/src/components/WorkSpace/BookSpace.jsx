              ...
              <div className="flex flex-col w-full gap-5">
                {availableSeats === 0 && (
                  <span className="text-mainRed">
                    No seat available for this selected date and plan
                  </span>
                )}
                <div className="flex flex-col gap-[17px]">
                  <div className="flex flex-c flex-row w-full gap-[17px]">
                    <div className="w-1/2 flex flex-col gap-4">
                      ...
                      >
                        <span>
                          {availableSeats > 0 ? numberOfSeates : availableSeats}
                        </span>
                ...
                <button
                  type="submit"
                  className={`text-white flex items-center text-center justify-center h-14 rounded-2xl font-semibold transition duration-400 ${
                    availableSeats === 0
                      ? "bg-mainRed opacity-[0.2] cursor-not-allowed"
                      : "bg-mainRed hover:bg-red-600 hover:cursor-pointer"
                  }`}
