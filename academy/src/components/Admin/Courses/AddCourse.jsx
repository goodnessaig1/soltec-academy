    ...
    <Layout text='Courses'>
      <div className='w-full inter__ flex flex-col gap-9 px-9 pb-[140px]'>
        ...
        <div className='flex flex-row justify-between'>
              ...
              <div className='flex flex-col gap-[22px]'>
                <div className='flex flex-col gap-[6px] '>
                  ...
                  <div className='w-full course_input rounded-[12px] h-10 text-[14px]'>
                    <input
                      ...
                      className='outline-none pt-[8px] pl-4 p-2.5 bg-transparent w-full'
                    />
                  </div>
                  <AnimatePresence>
                    {courseNameError && (
                  ...
                  <AnimatePresence>
                    ...
                    {videoSuccess && (
                      <motion.div
                        ...
                        exit={{ height: 0 }}
                        transition={{ duration: 0.7, ease: 'easeInOut' }}
                        className='flex mt-[4px] flex-row gap-3 items-center'
                      >
                        <img
                          src={Good}
                          className='w-6 h-6 rounded-[50%]'
                ...
                <div className='flex flex-row items-center gap-3'>
                  <div className='flex flex-col  gap-[6px]'>
                    <div
                      ...
                      className='w-[208px] px-2 gap-4 flex items-center hover:bg-[#f1f1f1] hover:cursor-pointer transitiion duration-300 course_input rounded-[12px] h-[48px] text-[14px]'
                    >
                      <img src={AddRound} alt='' />
                      <span className='font-semibold text-base leading-[24px]'>
                        Add course overview
                      </span>
                    </div>
                    <AnimatePresence>
                ...
                <div className='flex flex-row items-center gap-3'>
                  <div
                    ...
                    className='w-[246px] px-2 gap-4 flex items-center hover:bg-[#f1f1f1] hover:cursor-pointer transitiion duration-300 course_input rounded-[12px] h-[48px] text-[14px]'
                  >
                    <img src={AddRound} alt='' />
                    <span className='font-semibold text-base leading-[24px]'>
                ...
                <div className='flex flex-row items-center gap-3'>
                  <div
                    ...
                    className='w-[122px] px-2 gap-4 flex items-center hover:bg-[#f1f1f1] hover:cursor-pointer transitiion duration-300 course_input rounded-[12px] h-[48px] text-[14px]'
                  >
                    <img src={AddRound} alt='' />
                    <span className='font-semibold text-base leading-[24px]'>
                      Add FAQ
                ...
                {!overallLoading ? (
                  <button
                    className='bg-mainBlue hover:opacity-[0.9] transition duration-300 rounded-[16px] h-[48px] flex items-center justify-center w-full text-white text-base leading-[24px] font-semibold'
                    type='submit'
                  >
                    Add
                  </button>
          ...
          <div className='flex flex-col gap-4 w-[365px] items-center '>
            <h1 className='font-medium text-base leading-[20px]'>
              CARD PREVIEW
            </h1>
            <div
              style={{ backgroundColor: background }}
              className='w-full h-[320px] p-8 items-center flex flex-col gap-[15px] rounded-[24px]'
            >
              {!courseName ? (
                <div className='text-white text-[32px] leading-[48px] font-[700] text-center text-white'>
                  Course Name
                </div>
              ) : (
                <div className='text-white text-nowrap text-[32px] leading-[48px] font-[700] text-center text-white'>
              ...
              {!courseDescription ? (
                <span className='text-medium text-base items-center text-center leading-[24px] text-extraGray'>
                ...
                <>
                  {courseDescription.length > 120 ? (
                    <span className='text-medium max-w-[310px] break-words text-base items-center text-center leading-[24px] text-extraGray'>
              ...
              <div className='flex w-full flex-col items-center gap-3'>
                {!price ? (
                  <h1 className='text-[20px] font-[700] leading-[30px] text-white text-center'>
                    Price
                  </h1>
                ) : (
                  <h1 className='text-[20px] font-[700] leading-[30px] text-white text-center'>
                ...
                <div className='w-full h-[48px] border border-[1px] bg-white rounded-[16px] border-borderLight text-center items-center justify-center flex'>
                  Enroll now
                </div>
              </div>
            </div>
