...
import { BackArrow, BlogPost2 } from '../../../Utils/Assets';
    ...
    <Layout text='Blog'>
      <div className='w-full inter__ flex flex-col gap-9 px-9 pb-[140px]'>
        ...
        <div className='lg:w-[708px]'>
          ...
          <div className='flex mt-6 lg:mt-[40px] items-center'>
            <img src={BlogPost2} alt='' />
          </div>
          <div className='text-[14px] lg:text-[16px] mt-4 lg:mt-6 mb-5 fontTyp leading-[21px] lg:leading-[24px] font-normal '>
            <p>Introduction:</p>
            <p>
