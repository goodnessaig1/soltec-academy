    ...
    <div className='w-full'>
      ...
      <div className='flex fontTyp flex-col mt-11 lg:mt-[60px] px-4 lg:px-[120px] items-center'>
        <div className='lg:w-[708px]'>
          ...
          <div className='flex mt-4 lg:mt-10 items-center'>
            <img src={PaymentGuide1} alt='' />
          </div>
          <div className='text-[14px] lg:text-[16px] mt-4 lg:mt-4 mb-5 fontTyp leading-[21px] lg:leading-[24px] font-normal '>
            <p>Introduction:</p>
            <p>
