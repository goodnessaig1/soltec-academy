...
const Testimonial = () => {
  return (
    <div className='w-full bg-bg3 flex flex-col items-center pt-[97px] pb-[150px] justify-center '>
      ...
      <Marquee
        speed={55}
        className='flex flex-row mt-[80px] gap-[24px] '
        direction='left'
      >
      ...
      <Marquee
        speed={55}
        className='flex flex-row mt-[140px] gap-[24px] '
        direction='right'
      >
